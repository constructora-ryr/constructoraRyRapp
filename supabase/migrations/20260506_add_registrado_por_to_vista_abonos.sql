-- =====================================================
-- MIGRACIÓN: Agregar registrado_por_nombre a vista_abonos_completos
-- Fecha: 2026-05-06
-- Motivo: El módulo de abonos no mostraba quién registró cada
--         pago, a diferencia del historial del cliente que sí lo hace.
--         Se agrega JOIN con usuarios para traer el nombre completo.
-- =====================================================
...
COMMENT ON VIEW vista_abonos_completos IS
  'Vista optimizada de abonos con todos los JOINs. Incluye financieros de la negociación y nombre del usuario que registró el abono.';
